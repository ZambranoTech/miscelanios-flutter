...
class LocalAuthState {
  ...
  @override
  String toString() => 'LocalAuthState(didAuthenticate: $didAuthenticate, status: $status, message: $message)';
}

class LocalAuthNotifier extends StateNotifier<LocalAuthState> {
  LocalAuthNotifier(): super(LocalAuthState());

  Future<( bool, String )> authenticateUser({ biometricOnly = false }) async {
